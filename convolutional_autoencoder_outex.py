...
class ConvolutionalAutoencoder(object):
    ...
    def __init__(self):
        ...
        encoded = FullyConnected(80, activation=tf.nn.softmax, scope='encode')(unfold)
        # decode
    ...
    def reconstruct(self):
        ...
        with tf.Session() as sess:
            ...
            activation = sess.run(self.encoded, feed_dict={self.x: x})
            print(activation)

            #print(org, recon)

            input_images = weights_to_grid(org.transpose((1, 2, 3, 0)), 12, 12)
            recon_images = weights_to_grid(recon.transpose((1, 2, 3, 0)), 12, 12)
